...
import { About, Blog, Brick1100, Metrics, Services, Testimonials, Win7Simu } from '@/.vitepress/config/sitelinks';
...
const visnalizeLinks = [Blog, About, Services, Metrics, Testimonials]
</script>
