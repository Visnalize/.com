...
import { About, Blog, Metrics, Brick1100, Resources, Testimonials, Win7Simu } from '@/.vitepress/config/sitelinks';
...
const visnalizeLinks = [About, Metrics, Blog, Testimonials, Resources.Index]
</script>
