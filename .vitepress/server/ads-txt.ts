...
const APPLOVIN_APP_ADS_TXT = `applovin.com, 5dafb2d1ede14462c9663ed8a9edeaa3, DIRECT
...
const LIFTOFF_APP_ADS_TXT = `vungle.com, 698ee70d814b9fb754035a83, DIRECT, c107d686becd2d77
...
export const generateAppAdsTxt = () => {
  ...
  const appAdsTxtValue = `${GOOGLE_ADS_TXT}\n${APPLOVIN_APP_ADS_TXT}\n${LIFTOFF_APP_ADS_TXT}`;
