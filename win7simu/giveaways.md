---
title: Win7 Simu Giveaways
description: We occasionally give away Win7 Simu's themes and in-app items. Check this page for the latest giveaways and how to redeem them.
---
...
2. On the checkout page, scroll to the bottom and click __Add a discount code__.
  ![Add a discount code button](./giveaways/img/redeem-web-1.webp)
3. Enter the giveaway code and click __Apply__.
  ![Redeem code input](./giveaways/img/redeem-web-2.webp)
4. If the code is valid, you will see the discount applied. Enter your email address to receive the item.
  ![Code applied successfully](./giveaways/img/redeem-web-3.webp)
...
3. Enter the giveaway code and click __Redeem__.
  ![Redeem code on web](./giveaways/img/redeem-android-1.webp)
4. If the code is valid, you will see the confirmed item. Click __Add item__ to receive it.
  ![Code applied successfully](./giveaways/img/redeem-android-2.webp)
...
![Redeem code on Android](./giveaways/img/redeem-android-3.webp)
