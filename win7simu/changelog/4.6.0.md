---
title: Win7 Simu 4.6.0 release notes
description: Everything that changed in Win7 Simu 4.6.0 - new and improved games, a customizable taskbar and start menu, a rebuilt File Explorer, and full read-write support on the Android drive.
comments: false
...
summary: A big update for the built-in games, the taskbar and start menu, File Explorer, and full read-write support on the Android drive.
video: _efuxzOlE5M
prev:
  text: Changelog
