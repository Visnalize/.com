---
title: Win7 Simu credits & legal notices
description: This page documents third-party assets, licenses, and policies used in Win7 Simu, including user-generated content.
ads: false
social: false
---
...
In Win7 Simu, we use a variety of third-party assets, including icons, images, sounds, and source code. These assets are integral to the functionality and aesthetics of the application, enhancing the user experience and providing a more authentic Windows 7 simulation. Below is a list of these assets, along with their respective licenses and attributions. We are committed to respecting the rights of the original creators and ensuring that all assets are used in compliance with their licenses.

## Microsoft Windows assets

As the primary inspiration for Win7 Simu, we have utilized various assets derived from Microsoft Windows 7, and other versions of Windows, including:
...
Below is a list of specific assets we have used in Win7 Simu:

- **Wallpapers**: the wallpapers from Windows 7 and the default wallpapers of other Windows versions as listed above.
- **Icons**: system icons of different Windows versions, including those for My Computer, Recycle Bin, Control Panel, Notepad and others.
- **Sounds**: system sounds of different Windows versions, including startup, shutdown, notification, error sounds, and others.
...
We do not claim ownership over user-submitted content and cannot verify the origin of every asset used. It is the responsibility of each user to ensure that they have the right to use and share the content included in their themes.

If you are a rights holder and believe your work has been included in a user-generated theme without permission, please contact us at [hey@visnalize.com](mailto:hey@visnalize.com). We take such reports seriously and will act promptly to investigate and, if necessary, remove the content.

## Open-source software

Win7 Simu is built using various open-source libraries and frameworks. We acknowledge the contributions of these projects and comply with their respective licenses. Below is a list of some of the key open-source components used in the project:
