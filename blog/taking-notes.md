...
![Ad promo](https://images.unsplash.com/photo-1517842645767-c639042777db?auto=format&fit=crop&w=740&q=80)

_Cover image by David Travis via [Unsplash](https://unsplash.com/photos/5bYxXawHOQg)_
...
- A [listing page](/notes.md) that shows all the notes.
- The notes are stored in [GitHub](https://github.com/Visnalize/.com/tree/v2/notes).
- Each note is a [markdown file](https://github.com/Visnalize/.com/blob/v2/notes/embrace-mediocre.md), with a timestamp, title, and content.
